...
describe('GithubService', () => {
  ...
  describe('the getUser method', () => {
    ...
    beforeEach(() => {
      fakeUrlService.urlToUser.callsFake(() => Symbol('a generated URL'));
  ...
  describe('the getRepos method', () => {
    ...
    beforeEach(() => {
      fakeUrlService.urlToRepoList.callsFake(() => Symbol('some url'));
    ...
    describe('multi page result, getting page 1/3', () => {
      ...
      const pageThreeOfThree = {
        body: { repos: [7,8,9] },
        headers: { get: () => 'rel="last"' },
      };
